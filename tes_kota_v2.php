<?php
echo "<h1>Tes API Komerce (Ambil Kota - v2 BENAR)</h1>";

// 1. Masukkan API Key "Shipping Cost" Anda
$apiKey = 'SrZPSdpo43fc1282affbab5brmYUADKf'; // <-- Ganti dengan Key Anda

// 2. Tentukan URL Endpoint yang BENAR (sesuai dokumentasi)
// Kita masukkan ID provinsi (5) langsung ke dalam URL
$url = 'https://rajaongkir.komerce.id/api/v1/destination/city/5';
